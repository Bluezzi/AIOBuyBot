...
const userinput_store = () => {
    return new Promise((resolve, reject) => {
        rl.question(`Please select a store \n`, (selected_store) => {
            ...
            correct_store = false 
            while (!store_input_list.includes(selected_store)) {
                correct_store == false 
            }
            if (correct_store == false)  {
                reject(`${selected_store} is an invalid store`)
            } else{
                correct_store == true
...
async function main() {
    ...
    //BOT Functions
    //Store Input
    // let store_input = await userinput_store();
    // let store_input_list = [
    //     "bb",
    //     "gs",
    //     "n",
    ...
    // while (store_input_list.includes(store_input)) {
    // } if (!store_input_list.includes(store_input)){
    //     console.log(`Please retry, Store Input Invalid.`)
    //     await userinput_store()
    // }
